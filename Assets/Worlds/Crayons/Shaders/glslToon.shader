Shader "Custom/glslToon2" {
Properties {
	 	_Color ("Color", Color) = (1,1,1,.5)
	 	_DarkColor ("DarkColor", Color) = (1,1,1,.5)
...
SubShader {
	Pass { 
         ...
         void main() {
 			...
 			uniform vec4 _MainTile;
		
        void main()
         {
         	vec2 nUV = uv*_Tile;
         	vec4 Main = texture2D(_MainTex, (uv*_MainTile.xy)+_MainTile.zw);
         	Main.a = Main.r;
			...
			vec4 emit = mix(vec4(0,0,0,0),
						   ...
						   mix(CR4, vec4(1,1,1,1), 
						   		clamp((2.*_Color.a*(_Color.a*Main.a)-0.75)*10.0, 0.0, 1.0)),
						   		clamp((2.*_Color.a*(_Color.a*Main.a)-0.6)*10.0, 0.0, 1.0)),
						   		clamp((2.*_Color.a*(_Color.a*Main.a)-0.45)*10.0, 0.0, 1.0)),
						   		clamp((2.*_Color.a*(_Color.a*Main.a)-0.3)*10.0, 0.0, 1.0)),
						   		clamp((2.*_Color.a*(_Color.a*Main.a)-0.15)*10.0, 0.0, 1.0));
						   		

			vec4 L = mix(_DarkColor,_Color,emit.a); 		
            gl_FragColor = L;
